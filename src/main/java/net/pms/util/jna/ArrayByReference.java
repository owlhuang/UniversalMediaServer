 ...
 * placed adjacent to each other and without a terminator.
 *
...
public abstract class ArrayByReference<E> extends PointerType {
	...
	abstract protected E[] getElements();

	abstract protected void setElements(E[] array);
	...
	/**
	 * This is not allowed for {@link ArrayByReference}.
	 *
